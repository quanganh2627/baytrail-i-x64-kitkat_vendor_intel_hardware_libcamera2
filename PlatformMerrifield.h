...
public:
    PlatformSaltBay(void) {
        ...
        pcam->dvs = false;
        pcam->flipping = PlatformData::SENSOR_FLIP_V; /* vertical flip needed */
...
class PlatformBodegaBay : public PlatformBase {

public:
    PlatformBodegaBay(void) {
        mSubDevName = "/dev/v4l-subdev8";
        ...
        mBackFlash = true;
        mContinuousCapture = false;
        mMaxContinuousRawRingBuffer = 11;
        mVideoPreviewSizePref = "1024x576";
